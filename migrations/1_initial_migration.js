const token = artifacts.require('../contracts/GYPToken.sol')
const crowdsale = artifacts.require('../contracts/GYPCrowdsale.sol')
const setDefaultAccount = require('../scripts/setDefaultAccount.js')

module.exports = function(deployer, network, accounts) {
    const rate = new web3.BigNumber(10000)
    const wallet = '0x27cfee5b831c80a5c8f836d4e51120e628e9356b'
